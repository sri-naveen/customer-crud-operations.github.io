...
<%@ page import="com.customer.model.Customer, com.customer.daoImpl.CustomerDaoImpl"%>
...
<html>
	...
	<div>
		...
		Customer customer = obj.getCustomer(Integer.parseInt(customerId));
		%>
	    <form action="updateCustomer?customerId=<%=customer.getId()%>" method="post">
